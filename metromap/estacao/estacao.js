// Dados das estações com coordenadas e linhas de ônibus que passam
const estacoes = {
...
// Exibe informações da estação ao clicar
canvas.addEventListener('click', function(event) {
    ...
    for (const estacao in estacoes) {
        ...
        // Verifica se o clique está próximo da estação (raio de 15 pixels)
        if (distancia < 15) {
            // Exibe as informações da estação
